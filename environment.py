...
class MazeEnvironment:
    """
    Spec-aligned environment wrapper.

    The project assets only expose colored teleport pairs, so teleports are modeled
    as deterministic source-to-source mappings between each discovered pair.
    """
